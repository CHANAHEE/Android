package com.cha.mvc.model

import android.content.Context


// 13_ 데이터를 제어하는 기능 2개를 가진 클래스
class ItemModel constructor(val context: Context) { // 15_ 데이터를 제어하기 위해 Context 능력이 필요한 경우가 있다면 주 생성자로 전달받기

    // 14.
    // 1) 데이터를 전달받아 SharedPreference 에 데이터를 저장하는 기능
